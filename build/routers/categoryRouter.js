...
var CategoryRouter = /** @class */ (function () {
    ...
    CategoryRouter.get = function () {
        ...
        router.post('/insert', function (req, res) {
            categories_1.Categories.query().insertAndFetch(req.body).then(function (value) {
                return res.status(200).send(value);
            })
                .catch(function (reason) {
                    return res.status(200).send(reason);
        ...
        router.post('/delete', function (req, res) {
            categories_1.Categories.query().deleteById(req.body.id).then(function (value) {
        ...
        router.put('/update', function (req, res) {
            categories_1.Categories.query().updateAndFetchById(req.body.id, req.body).then(function (value) {
                return res.status(200).send(value);
            })
                .catch(function (reason) {
                    return res.status(200).send(reason);
