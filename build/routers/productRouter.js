                    ...
                    switch (_a.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, objection_1.transaction(objection_1.Model.knex(), function (trx) { return __awaiter(_this, void 0, void 0, function () {
                                    ...
                                    return __generator(this, function (_a) {
                                        switch (_a.label) {
                                            case 0: return [4 /*yield*/, products_1.Products.query(trx)
                                                    .where('id', req.body.id)
                                                    .first()];
                                            case 1:
                                                product = _a.sent();
                                                product.deleted = new Date();
                                                return [2 /*return*/, (products_1.Products.query().updateAndFetchById(product.id, product).then(function (value) { return res.status(200).send(value); })
                                                        .catch(function (reason) { return res.status(403).send(reason); }))];
                                        }
                                    });
                                }); })];
