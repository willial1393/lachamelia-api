                                    ...
                                    return __generator(this, function (_a) {
                                        switch (_a.label) {
                                            ...
                                            case 1:
                                                ...
                                                tables_1.Tables.query().updateAndFetchById(table.id, table).then(function (value) { return res.status(200).send(value); })
                                                    .catch(function (reason) { return res.status(403).send(reason); });
                                                return [4 /*yield*/, orders_1.Orders.query(trx)
                                            ...
                                            case 2:
                                                ...
                                                order.end = new Date();
                                                console.log(order);
                                                return [2 /*return*/, (orders_1.Orders.query().updateAndFetchById(order.id, order).then(function (value) { return res.status(200).send(value); })
                                                        .catch(function (reason) { return res.status(403).send(reason); }))];
                                        }
                                    });
                                }); })];
